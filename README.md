...
- **[Agent Web Search](https://github.com/tiagohanna123/agent-web-search-mcp)** - DuckDuckGo web search + URL content extraction MCP server. Free tier: 7 req/IP/day (no API key). Pro: unlimited (R$50). Hosted HTTP endpoint.
